				...
				<div class="card-body pt-0">
					...
					<div class="mini-stats-wid d-flex align-items-center mt-3">
						...
						<div class="flex-shrink-0">
							<p class="text-muted mb-0">
								02:00
								<span class="text-uppercase">pm</span>
							</p>
						</div>
					</div>
					<!-- end -->
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="progress progress-sm flex-grow-1" style="
                                                                        width: 68%;
                                                                    ">
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="progress flex-grow-1 progress-sm" style="
                                                                        width: 68%;
                                                                    ">
												<div class="progress-bar bg-primary rounded" role="progressbar" style="
                                                                            width: 64%;
		...
		<div class="col-xl-5">
			<div class="card card-height-100">
				<div class="card-header align-items-center d-flex">
					<h4 class="card-title mb-0 flex-grow-1 py-1">
						My Tasks
					</h4>
					<div class="flex-shrink-0">
							...
							<tbody>
								<tr>
									...
									<td>
										<h6 class="mb-0">
											110h :
											<span class="text-muted">150h</span>
										</h6>
									</td>
									<td>258</td>
									<td style="width: 5%">
									...
									<div class="conversation-list">
										...
										<div class="user-chat-content">
											...
											<div class="conversation-name">
												<small class="text-muted time">09:07
													am</small>
								...
								<li class="chat-list right">
									<div class="conversation-list">
										<div class="user-chat-content">
											...
											<div class="conversation-name">
												<small class="text-muted time">09:08
													am</small>
												<span class="text-success check-message-icon"><i
														class="ri-check-double-line align-bottom"></i></span>
											</div>
								...
								<li class="chat-list left">
									<div class="conversation-list">
										...
										<div class="user-chat-content">
											...
											<div class="conversation-name">
												<small class="text-muted time">09:10
													am</small>
												<span class="text-success check-message-icon"><i
														class="ri-check-double-line align-bottom"></i></span>
											</div>
								...
								<li class="chat-list right">
									<div class="conversation-list">
										<div class="user-chat-content">
											...
											<div class="conversation-name">
												<small class="text-muted time">09:12
													am</small>
												<span class="text-success check-message-icon"><i
														class="ri-check-double-line align-bottom"></i></span>
											</div>
								...
								<li class="chat-list left">
									<div class="conversation-list">
										...
										<div class="user-chat-content">
											...
											<div class="conversation-name">
												<small class="text-muted time">09:30
													am</small>
												<span class="text-success check-message-icon"><i
														class="ri-check-double-line align-bottom"></i></span>
											</div>
